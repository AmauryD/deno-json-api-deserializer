export interface JsonApiTopLevelDocument<T extends Record<string,unknown> = Record<string,unknown>> {
...
export type JsonApiResourceLinkage = null | [] | JsonApiResourceIdentifier | JsonApiResourceIdentifier[];
...
export interface JsonApiResourceObject<T extends Record<string,unknown> = Record<string,unknown>> {
